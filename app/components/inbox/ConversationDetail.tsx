        ...
        <>
            ...
            >
                {messages.map((message, index) => (
                    <div
                        key={index}
                        className={`w-[80%] px-6 rounded-xl ${message.created_by.name == myUser?.name ? 'ml-[20%] bg-blue-200' : 'bg-gray-200'}`}
                    >
                ...
                {realtimeMessages.map((message, index) => (
                    <div
                        key={index}
                        className={`w-[80%] px-6 rounded-xl ${message.name === myUser?.name ? 'ml-[20%] bg-blue-200' : 'bg-gray-200'}`}
                    >
